...
import { Container as Flex } from '../../styles/Input.styles'
        ...
        <div style={{ backgroundColor: '#fff', padding: '2em' }}>
            <Flex {...FlexProps}>
                ...
                <p>
                    ...
                    nibh at velit scelerisque suscipit.
                    <br />
                    <br />
                    Duis lobortis massa imperdiet quam. Aenean posuere, tortor
                    sed cursus feugiat, nunc augue blandit nunc, eu sollicitudin
                    urna dolor sagittis lacus. Fusce a quam. Nullam vel sem.
